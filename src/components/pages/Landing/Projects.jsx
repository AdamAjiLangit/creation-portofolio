    ...
    const data = [
        {
            ...
            content: (
                <div>
                    ...
                    <AnimatedButton text="View" url="" customClass="mb-10" />
        ...
        },
        {
            ...
            content: (
                <div>
                    ...
                    <AnimatedButton text="View" url="https://agen-umroh.vercel.app/" customClass="mb-10" />
                    <div className="grid grid-cols-2 gap-4">
                        <Image
                    ...
                    <AnimatedButton text="View" url="https://rental-motor-kudus.vercel.app/" customClass="mb-10" />
                    <div className="grid grid-cols-2 gap-4">
                        <Image
        ...
        },
        {
            ...
            content: (
                <div>
                    ...
                    <AnimatedButton text="View" url="https://website-kalimantan-barat.vercel.app/" customClass="mb-10" />
                    <div className="grid grid-cols-2 gap-4">
                        <Image
                        ...
                        <Image
                            ...
                            className="rounded-lg object-cover h-20 md:h-44 lg:h-60 w-full shadow-[0_0_24px_rgba(34,_42,_53,_0.06),_0_1px_1px_rgba(0,_0,_0,_0.05),_0_0_0_1px_rgba(34,_42,_53,_0.04),_0_0_4px_rgba(34,_42,_53,_0.08),_0_16px_68px_rgba(47,_48,_55,_0.05),_0_1px_0_rgba(255,_255,_255,_0.1)_inset]" />
                        <Image
                            src="/assets/images/jelajahKalbar/culinary.png"
                            alt="startup template"
                            width={500}
                            height={500}
                            className="rounded-lg object-cover h-20 md:h-44 lg:h-60 w-full shadow-[0_0_24px_rgba(34,_42,_53,_0.06),_0_1px_1px_rgba(0,_0,_0,_0.05),_0_0_0_1px_rgba(34,_42,_53,_0.04),_0_0_4px_rgba(34,_42,_53,_0.08),_0_16px_68px_rgba(47,_48,_55,_0.05),_0_1px_0_rgba(255,_255,_255,_0.1)_inset]" />
